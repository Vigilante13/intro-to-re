...
Analyzing our source code can help us avoid using brute force to solve program checkers. In the [next section](https://vigilante13.github.io/intro-to-re/tools.html) I'm going to over Tools that reverse engineers use to understand program flow and construct scripts to crack the program.
